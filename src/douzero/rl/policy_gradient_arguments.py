...
parser = argparse.ArgumentParser(
    description="DouZero: linear-feature policy gradient"
)

parser.add_argument("--episodes", default=10000, type=int,
                    help="Number of self-play episodes")
parser.add_argument("--name", default="pg_logadp_10k_history", type=str,
...
parser.add_argument("--savedir",
                    default="policy_gradient_checkpoints/policy_gradient",
                    help="Root directory for policy-gradient checkpoints")
