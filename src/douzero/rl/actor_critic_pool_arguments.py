...
parser = argparse.ArgumentParser(
    description="DouZero: linear-feature actor-critic with an opponent pool"
)

parser.add_argument("--episodes", default=10000, type=int,
                    help="Number of training episodes")
parser.add_argument("--name", default="ac_pool_logadp_10k_history", type=str,
...
parser.add_argument("--savedir",
                    default="actor_critic_checkpoints/actor_critic_pool",
...
parser.add_argument("--opponent_pool", default="current,rlcard,heuristic,random",
                    type=str,
                    help=("Comma-separated opponent methods; supports current, "
                          "ac:path, and pg:path"))
