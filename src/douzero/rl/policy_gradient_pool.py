...
def training_metadata_with_pool(flags, global_episode, temperature, load_path,
    ...
    metadata["algorithm"] = "linear_policy_gradient_opponent_pool"
...
def train(flags):
    ...
    if load_path:
        ...
        print(
            "loaded pool policy-gradient model from {} "
            "(episodes={}, updates={})".format(
                load_path,
                completed_episodes,
                model.num_updates,
            )
    ...
    print("Policy-gradient pool feature mode: {}".format(model.feature_mode))
    ...
    for episode in range(1, flags.episodes + 1):
        ...
        if should_log:
            ...
            print(
                ...
                "current_wp={:.3f} avg_steps={:.1f} avg_return={:.3f} "
        ...
        if should_save:
            ...
            print("saved policy-gradient pool model to {}".format(path))
    ...
    print("saved policy-gradient pool model to {}".format(final_path))
    return model
